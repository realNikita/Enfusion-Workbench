...
import com.flipperplz.enfusionWorkbench.languages.param.psi.mixin.ParamGIdentifierMixin;
import com.flipperplz.enfusionWorkbench.languages.param.psi.*;

public class ParamGIdentifierImpl extends ParamGIdentifierMixin implements ParamGIdentifier {

  public ParamGIdentifierImpl(ASTNode node) {
    super(node);
  }
